...
{
    public interface ISheetUseCase
    {
        ...
        void ApplyTagsToSelectedOnCurrentView(IList<string> selectedFamilyIds);
        ...
        void ApplyTagsToAllOnCurrentView(IList<string> selectedFamilyIds);
