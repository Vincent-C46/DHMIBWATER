...
public sealed record FittingPlacementDefinition(Guid Id, string TypeKey, string FamilyTypeName, Point2D Position, double Elevation, Guid? EdgeId = null, Guid? NodeId = null);
