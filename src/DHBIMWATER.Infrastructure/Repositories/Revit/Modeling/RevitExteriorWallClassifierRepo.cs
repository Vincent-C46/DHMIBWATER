...
namespace DHBIMWATER.Infrastructure.Repositories.Revit.Modeling
{
    internal class RevitExteriorWallClassifierRepo : IExteriorWallClassifierRepo
    {
        ...
        public IReadOnlyList<(long ElementId, Point2D Start, Point2D End)> GetWallEndpoints()
        {
            var doc = _doc();
            if (doc == null) return [];
            ...
            return new FilteredElementCollector(doc)
                ...
                .Select(wall =>
                {
                    ...
                    if (curve == null) return ((long ElementId, Point2D Start, Point2D End)?)null;
        ...
        public void SetExteriorFlag(long elementId, bool isExterior)
        {
            var doc = _doc();
            if (doc == null) return;
